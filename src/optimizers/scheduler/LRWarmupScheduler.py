...
class LRWarmupScheduler:
    ...
    def __init__(
        ...
        if self._is_plateau: # 判断时候是ReduceLROnPlateau调节器
            assert by_epoch
    ...
    def _pre_compute_regular_lrs_per_t(self, max_t: int):
    ...
    def _get_warmup_lrs(self, t: int, regular_lrs: List[float]):
